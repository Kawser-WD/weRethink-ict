...
const NavLinks = () => {
  ...
  return (
    <>
      {links.map((link, i) => (
        <div key={i}>
          <div className="sm:cursor-pointer group">
            <h1
              ...
              <div>
                <div className="absolute top-20 hidden group-hover:md:block hover:md:block">
                  ...
                  <div className="bg-white py-2 px-10 flex flex-col">
                    {link.sublink.map((mysublinks, i) => (
                      <div key={i} className="hover:bg-[#caccd1]">
                        <li className="text-sm text-gray-600 my-2 px-2">
                          <Link
                            to={mysublinks.link}
          ...
          <div className={`${heading === link.name ? "md:hidden" : "hidden"}`}>
            {link.sublink.map((slinks, i) => (
              <div key={i}>
                <li className="py-4 pl-7 text-sm font-semibold flex justify-between items-center md:pr-0 pr-5">
